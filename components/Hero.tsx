        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="flex flex-col items-start gap-4 mb-6">
              <div
                className="inline-flex items-center justify-center bg-[#F4D58D] text-[#1A1612] font-mono text-[11px] font-semibold uppercase tracking-wider px-3 py-1.5 rounded-md shadow-xs select-none relative z-10"
              ...
              {levelLabel && (
                <div className="inline-flex items-center gap-1.5 bg-white/[0.08] border border-white/15 text-white/85 text-[11px] font-medium uppercase tracking-wider px-3 py-1.5 rounded-md">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#F4D58D] shrink-0" />
