              ...
              <div className="relative md:col-span-5 text-white flex flex-col justify-end min-h-[360px] md:min-h-[460px] overflow-hidden">
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    <div className="absolute inset-0 bg-linear-to-t from-[#1A1612]/90 via-[#1A1612]/40 to-transparent"></div>
                  </motion.div>
                </AnimatePresence>
                  ...
                  <div className="flex items-center justify-between mt-8">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="w-9 h-9 grid place-items-center rounded-full border border-white/20 bg-black/20 backdrop-blur-xs hover:bg-white/20 transition-colors"
                        aria-label="Previous">
