      ...
      <div className="mx-auto max-w-[800px] px-5 md:px-8">
        ...
        <Reveal delay={0.05}>
          <div className="relative overflow-visible">
            ...
            <div className="flex items-center gap-3 bg-white rounded-2xl border px-5 h-16 transition-all border-[#E2DBCF] shadow-sm focus-within:border-[#C42828] focus-within:ring-4 focus-within:ring-[#C42828]/12">
                  ...
                  <div className="bg-white rounded-[28px] border border-[#E2DBCF] shadow-surface overflow-hidden">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-[#EFE9DD]">
                      <div className="px-4 py-6 text-center">
                        <div className="text-[11px] text-[#9A9087] mb-1.5 font-medium uppercase tracking-wider">Admission Fee</div>
                        <div className="num text-[20px] font-semibold text-[#1A1612]">{pkr(p.admissionFee)}</div>
                        <div className="text-[12px] text-[#5A524A] mt-1">(One time)</div>
                      </div>
                      <div className="px-4 py-6 text-center">
                        <div className="text-[11px] text-[#9A9087] mb-1.5 font-medium uppercase tracking-wider">1st Semester</div>
                        <div className="num text-[20px] font-semibold text-[#1A1612]">{pkr(p.firstSemesterFee)}</div>
                        <div className="text-[12px] text-[#5A524A] mt-1">(Including admission)</div>
                      </div>
                      <div className="px-4 py-6 text-center">
                        <div className="text-[11px] text-[#9A9087] mb-1.5 font-medium uppercase tracking-wider">Onward Semesters</div>
                        <div className="num text-[20px] font-semibold text-[#1A1612]">{pkr(p.onwardSemesterFee)}</div>
                        <div className="text-[12px] text-[#5A524A] mt-1">(Per semester)</div>
                      </div>
                      <div className="px-4 py-6 text-center">
                        <div className="text-[11px] text-[#9A9087] mb-1.5 font-medium uppercase tracking-wider">Est. Total</div>
                        <div className="num text-[20px] font-semibold text-[#7A1818]">~{pkr(p.totalCourseFee)}</div>
                        <div className="text-[12px] text-[#5A524A] mt-1">({semestersToDuration(p.semesters)})</div>
                      </div>
                    </div>
                    ...
                    <div className="px-6 md:px-8 py-5 md:py-6 bg-white border-t border-[#EFE9DD]">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        <Button as={Link} to="/" variant="primary" size="lg" className="w-full sm:w-fit">
