...
export const dict: Dict = {
  ...
  'how.headline': {
    en: 'Three steps. About 5 minutes.',
    ur: 'تین مراحل۔ تقریباً 5 منٹ۔'
  },
  'how.sub': {
    en: 'No paperwork, no waiting in line. Simple steps, big opportunities.',
    ur: 'کوئی کاغذی کارروائی نہیں، کوئی قطار نہیں۔ آسان مراحل، بڑے مواقع۔'
  },
  'section.stories': {
    en: 'Graduate stories',
    ur: 'فارغ التحصیل کہانیاں'
  },
  ...
  'compare.sameProgramError': {
    en: 'Select two different programs.',
    ur: 'دو مختلف پروگرام منتخب کریں۔'
  },
  'programs.tabUG': {
    en: 'Undergraduate',
    ur: 'انڈرگریجویٹ'
  ...
  'programs.feeLink': {
    en: 'Check Fee Structure',
    ur: 'فیس کا ڈھانچہ دیکھیں'
  },
  'footer.crafted': {
  ...
  'find.cgpaTitle': {
    en: 'What was your CGPA?',
    ur: 'آپ کا CGPA کیا تھا؟'
  },
  'find.cgpaHelp': {
    en: 'Most CECOS postgraduate programs need 2.0+ CGPA. PhD programs need 3.0+ CGPA.',
    ur: 'زیادہ تر CECOS پوسٹ گریجویٹ پروگرامز کے لیے 2.0+ CGPA چاہیے۔ PhD کے لیے 3.0+ CGPA۔'
  }
};
type Ctx = {
  lang: Lang;
